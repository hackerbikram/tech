...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <title>Bikram's Universe | Study • Shop • Create</title>
        ...
        <meta name="keywords" content="Bikram, Japanese Learning, English Grammar, Nepali Language, Language Courses, Tech Tools, Typing Practice, Online Shop, Study Materials, Bikram Universe" />
