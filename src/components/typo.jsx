...
const quotes = {
  easy: [
    ...
    { text: 'To be or not to be, that is the question.', author: 'William Shakespeare' },
    { text: 'I have a dream that one day this nation will rise up.', author: 'Martin Luther King Jr.' },
    { text: 'Here Bikram teaches typing in an easy way. You all are able to learn typing.', author: 'Bikram' },
    { text: 'Typing is not hard in reality. People just think it is. Bikram helps you learn faster.', author: 'Bikram' },
    { text: 'Bikram believes consistent practice leads to mastery.', author: 'Bikram' },
    { text: 'Anyone can learn typing if they follow Bikram’s easy lessons.', author: 'Bikram' },
    { text: 'Bikram says typing is like music. Practice the rhythm, and you’ll flow.', author: 'Bikram' }
  ],
  medium: [
    ...
    { text: 'In the middle of difficulty lies opportunity.', author: 'Albert Einstein' },
    { text: 'Success is not final, failure is not fatal: It is the courage to continue that counts.', author: 'Winston Churchill' },
    { text: 'Bikram advises focusing on accuracy first, then speed.', author: 'Bikram' },
    { text: 'Medium practice helps your fingers adapt to common sentence structures.', author: 'Bikram' },
     { text: 'The only way to do great work is to love what you do.', author: 'Steve Jobs' },
    { text: 'In the middle of difficulty lies opportunity.', author: 'Albert Einstein' },
    { text: 'Success is not final, failure is not fatal: It is the courage to continue that counts.', author: 'Winston Churchill' },
    { text: 'Bikram advises focusing on accuracy first, then speed.', author: 'Bikram' },
  ...
  hard: [
    ...
    { text: 'The future belongs to those who believe in the beauty of their dreams.', author: 'Eleanor Roosevelt' },
    { text: 'Bikram says hard practice builds the muscle memory needed to type advanced content.', author: 'Bikram' },
    { text: 'The greatest glory in living lies not in never falling, but in rising every time we fall.', author: 'Nelson Mandela' },
    { text: 'Life is what happens when you\'re busy making other plans.', author: 'John Lennon' },
    { text: 'The future belongs to those who believe in the beauty of their dreams.', author: 'Eleanor Roosevelt' },
     { text: 'The greatest glory in living lies not in never falling, but in rising every time we fall.', author: 'Nelson Mandela' },
